...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-gradient-to-br from-background/95 to-background/80 backdrop-blur-xl shadow-2xl p-6 transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
