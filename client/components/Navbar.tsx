...
export default function Navbar() {
  ...
  return (
    <motion.nav
      className="sticky top-0 z-50 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 backdrop-blur-md bg-opacity-90 dark:bg-opacity-90"
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          >
            ...
            >
              <motion.div
                className="w-8 h-8 rounded-lg bg-gradient-to-br from-violet-600 to-cyan-600 flex items-center justify-center text-white text-sm font-bold"
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              ...
              {!isAuthenticated ? (
                <motion.div
                  className="pt-2 space-y-2 border-t border-slate-200 dark:border-slate-800 mt-2"
                  variants={containerVariants}
                  initial="hidden"
                  animate="visible"
                >
                ...
                <motion.div
                  className="pt-2 border-t border-slate-200 dark:border-slate-800 mt-2"
                  variants={containerVariants}
                  initial="hidden"
                  animate="visible"
                >
                  <motion.div
                    className="px-3 py-2 text-sm text-slate-600 dark:text-slate-400 mb-2"
                    variants={itemVariants}
                  >
                    {user?.name}
                  </motion.div>
